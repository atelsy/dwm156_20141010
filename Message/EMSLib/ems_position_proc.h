...
#ifndef _EMS_POSITION_PROC_H
#define _EMS_POSITION_PROC_H
 
extern kal_uint16 BwCancelCurrentPosition(EMSData *emsData, kal_uint16 steps, 
   kal_bool needCancel, kal_bool is_roll_back);
#endif /* _EMS_POSITION_PROC_H */
